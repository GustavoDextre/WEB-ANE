      ...
      <Animator animation={batch(Fade())}>
          <div className="mt-4 px-2">
            <div className="container-fluid fondoprincipal2 text-white py-3 text-center rounded">
              ...
              <iframe className="cuadro" src="https://www.youtube.com/embed/BZZ3whdJANE" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
          </div>
      </Animator>
      </ScrollPage>
